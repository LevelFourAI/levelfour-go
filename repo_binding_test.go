...
func TestSettersListAvailableReposAPIV1RepoBindingInstallationsInstallationIDReposGetRequest(t *testing.T) {
	t.Run("SetQuery", func(t *testing.T) {
		obj := &ListAvailableReposAPIV1RepoBindingInstallationsInstallationIDReposGetRequest{}
...
func TestSettersMarkExplicitListAvailableReposAPIV1RepoBindingInstallationsInstallationIDReposGetRequest(t *testing.T) {
...
func TestSettersRepoTargetPatchRequest(t *testing.T) {
	t.Run("SetInstallationID", func(t *testing.T) {
		obj := &RepoTargetPatchRequest{}
		var fernTestValueInstallationID *int
		obj.SetInstallationID(fernTestValueInstallationID)
		assert.Equal(t, fernTestValueInstallationID, obj.InstallationID)
		assert.NotNil(t, obj.explicitFields)
...
func TestSettersMarkExplicitRepoTargetPatchRequest(t *testing.T) {
	t.Run("SetInstallationID_MarksExplicit", func(t *testing.T) {
		t.Parallel()
		// Arrange
		obj := &RepoTargetPatchRequest{}
