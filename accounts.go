...
type CreateIntegrationRequest struct {
	...
	// Onboarding mode. AWS: single|organization. GitHub: github_app. GitLab: gitlab_oauth. Jira: jira_oauth.
...
var (
	...
	connectedAccountFieldRoleArn               = big.NewInt(1 << 3)
	connectedAccountFieldRegionName            = big.NewInt(1 << 4)
	connectedAccountFieldStatus                = big.NewInt(1 << 5)
	connectedAccountFieldIsManagementAccount   = big.NewInt(1 << 6)
	connectedAccountFieldOrganizationID        = big.NewInt(1 << 7)
	connectedAccountFieldConnectedAt           = big.NewInt(1 << 8)
	connectedAccountFieldCurStatus             = big.NewInt(1 << 9)
	connectedAccountFieldCurRegion             = big.NewInt(1 << 10)
	connectedAccountFieldCurLastIngestedAt     = big.NewInt(1 << 11)
...
type ConnectedAccount struct {
	...
	// AWS: deterministic ARN of LevelFourCrossAccountRole. GCP: the tenant service-account resource name.
